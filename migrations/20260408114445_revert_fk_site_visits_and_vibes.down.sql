-- Re-apply site_visits foreign key: point property_id to listings(id) instead of properties(id)
...
-- Re-apply vibes foreign key: point property_id to listings(id) instead of properties(id)
